...
public class AdapterForDoctorReplyToPat extends BaseAdapter {
    ...
    FetchingMsgFromDoctor_to_Pat context;
...
//    Datum_FetchingMsg doctoritem;
    ...
    public AdapterForDoctorReplyToPat(FetchingMsgFromDoctor_to_Pat context, List<Datum_FetchingMsg> data) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null)
            view = inflater.inflate(R.layout.activity_for_showing_doctormessage_to_pat, null);
        findids(view);
       // setActions(position);
